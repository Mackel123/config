...
## Type: FormatString
c.tabs.title.format = '{audio}{index}: {current_title}{private}{perc_raw}'
...
## for a blank page.
## Type: FuzzyUrl
c.url.default_page = 'https://manga-zip.tv/'
...
c.url.searchengines = {
        ...
        'rdd':      'https://www.reddit.com/search?q={}',
...
c.url.start_pages = ['https://manga-zip.tv/']
