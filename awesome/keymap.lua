...
awful.key({modkey, "Shift" }, "k", function () awful.util.spawn("kdenlive") end,
         {description = "open kdenlive", group = "application"}),
awful.key({modkey, "Shift" }, "o", function () awful.util.spawn("Opentoonz") end,
         {description = "open Opentoonz", group = "application"}),
awful.key({modkey, "Shift" }, "b", function () awful.util.spawn("blender") end,
